...
from .admin_module.dashboard import is_dashboard_enabled, is_dashboard_menu_enabled
...
class ProductReviewDashboardItem(DashboardItem):
    ...
    def get_context(self):
        ...
        context["reviews"] = ProductReview.objects.for_reviewer(self.request.shop, self.request.person).order_by(
            "-created_on"
        )[:5]
        return context
